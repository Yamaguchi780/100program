...
export const Result = () => {
  ...
  return(
    <div>
      ...
      <div className='header'><img src={norenImage} alt="のれん画像" onClick={() => {handleClick4()}}/></div>
      <div className='yazirushi'><img src={yazirushiImage} alt="矢印"/></div>
      <div className='yazirushiExplain'><img src={yazirushiExplainImage} alt="矢印説明"/></div>
      {/* <div>{receivedData1}</div>
      <div>missCounted: {receivedData2}</div>
      <div>経過時間: {receivedData3} 秒</div> */}
      <div className='arigatou'><img src={arigatouImage} alt="お礼"/></div>
      <div className='ToTitle' onClick={() => {handleClick3()}}><img src={ToTitleImage} alt="タイトル"/></div>
